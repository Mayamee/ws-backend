...
class MessageService {
  ...
  private saveMessages = async (data: MessageData) => {
    return this.fileService.saveFileContent('messages.json', JSON.stringify(data))
  }
...
const messageService = new MessageService(new FSService(FSServicePaths.MESSAGES))
